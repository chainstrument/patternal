...
export function getMDXComponents(): Record<string, any> {
  return {
    ...
    h2: (props: HeadingProps) => <h2 className="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight border-b border-border pb-2" {...props} />,
    ...
    pre: (props: PreProps) => (
      <pre className="my-4 overflow-x-auto rounded-lg border border-border bg-[#0d1117] p-4 text-sm" {...props} />
    ),
